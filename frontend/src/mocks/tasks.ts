...
export const initialTasks: Task[] = [
  ...
  { id: "adhkar-evening", title: "أذكار المساء", category: "faith", type: "adhkar", group: "evening", goalLabel: "الأذكار", target: 1, current: 0, unit: "جلسة", durationMinutes: 8, actualMinutes: 0, status: "not_started", scheduledTime: "بعد المغرب" },
  ...
  { id: "lesson-review", title: "مراجعة الدروس", category: "growth", type: "general", goalLabel: "دقائق المراجعة", target: 30, current: 0, unit: "دقيقة", durationMinutes: 30, actualMinutes: 0, status: "not_started", supportingText: "مراجعة درس اليوم" },
