...
export const activityEvents: ActivityEvent[] = [
  ...
  { id: "activity-2", participantId: "razi", participantName: "رازي", initials: "رز", avatarColor: "navy", action: "أوقف مؤقتًا", task: "ورد القرآن", time: "منذ 8 دقائق", kind: "paused" },
...
export const encouragements: EncouragementMessage[] = [
  ...
  { id: "enc-2", sender: "المشرف", initials: "مش", avatarColor: "navy", message: "ثباتك اليوم جميل، خذ الخطوة التالية بهدوء.", time: "أمس" },
];
