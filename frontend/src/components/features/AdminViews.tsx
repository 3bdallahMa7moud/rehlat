...
export function AdminDashboardView() {
  const { activity, participants, rankings, getReport } = useDemo(); const groupReport = getReport({ period: "weekly", participantId: "all", taskId: "all" });
